...
exports.DedicatedAgent = DedicatedAgent; // DedicatedAgent
...
exports.Blackboard = Blackboard; // Heap
var Ticker = (function () {
...
exports.BehaviorTree = BehaviorTree; // BehaviorTree
...
exports.BaseNode = BaseNode; // BaseNote
...
exports.Composite = Composite; // Composite
...
exports.Decorator = Decorator; // Decorator<T>
...
exports.MemSequence = MemSequence; // MemSequence
...
exports.MemSelector = MemSelector; // MemSelector
...
exports.RandomSelector = RandomSelector; // RandomSelector
/*
...
exports.Inverter = Inverter; // Inverter
...
exports.LimiterTime = LimiterTime; // LimiterTime
...
exports.LimiterTicks = LimiterTicks; // LimiterTicks
...
exports.RepeatUntilFailure = RepeatUntilFailure; // RepeatUntilFailure
...
exports.RepeatUntilSuccess = RepeatUntilSuccess; // RepeatUntilSuccess
...
exports.Succeeder = Succeeder; // Succeeder
...
exports.Failure = Failure; // Failure
...
exports.WaitTime = WaitTime; // WaitTime
...
exports.WaitTicks = WaitTicks; // WaitTicks
function createUUID() {
    var s = Array(36);
